...
export const Mage = new Set(['Bishop', 'Fire/Poison Archmage', 'Ice/Lightning Archmage', 'Arch Mage (Ice, Lightning)', 'Arch Mage (Fire, Poison)', 'Blaze Wizard', 'Luminous', 'Evan', 'Battle Mage', 'Kanna', 'Adele', 'Illium', 'Lara', 'Kinesis', 'Beast Tamer'])
...
export const Pirate = new Set(['Cannon Master', 'Cannoneer', 'Buccanner', 'Corsair', 'Jett', 'Thunder Breaker', 'Shade', 'Mechanic', 'Angelic Buster', 'Ark'])
