...
EventRing = {'Complete Sylph Ring', 'Reboot Complete Sylph Ring', 'Cosmos Ring', 'Reboot Cosmos Ring', 'Master Ring SS', 'Vengeful Ring', 'Reboot Vengeful Ring', 'Synergy Ring', 'Chaos Ring', 'Tenebris Expedition Ring', 'Reboot Tenebris Expedition Ring (Stage 1)', 'Reboot Tenebris Expedition Ring (Stage 2)', 'Reboot Tenebris Expedition Ring (Stage 3)', 'Reboot Tenebris Expedition Ring (Complete)', 'Glory Guard Ring: Guardian', 'Glory Guard Ring: Master', 'Glory Guard Ring: Commander', 'Glory Guard Ring: Justicar', 'Awake Ring', 'Reboot Awake Ring (Lv. 1)', 'Reboot Awake Ring (Lv. 2)', 'Reboot Awake Ring (Lv. 3)', 'Reboot Awake Ring (Lv. 4)', 'Eternal Flame Ring', 'Grand Adventure Ring', 'Adventure Deep Dark Critical Ring'}
TowerRing = {'Ring of Restraint', 'Ultimatum Ring', 'Limit Ring', 'Health Cut Ring', 'Mana Cut Ring', 'Durability Ring', 'Critical Damage Ring', 'Critical Defense Ring', 'Critical Shift Ring', 'Stance Shift Ring', 'Totalling Ring', 'Level Jump S Ring', 'Level Jump D Ring', 'Level Jump I Ring', 'Level Jump L Ring', 'Weapon Jump S Ring', 'Weapon Jump D Ring', 'Weapon Jump I Ring', 'Weapon Jump L Ring', 'Swift Ring', 'Overdrive Ring', 'Berserker Ring', 'Reflective Ring', 'Cleansing Ring', 'Risk Taker Ring', 'Crisis H Ring', 'Crisis M Ring', 'Crisis HM Ring', 'Clean Stance Ring', 'Clean Defense Ring', 'Tower Boost Ring'}
Names = TowerRing | EventRing | Totem | BossAccessorySet | CRAArmor | EternalArmor | PitchedBossSet | SuperiorGolluxSet | ReinforcedGolluxSet | SengokuTreasureSet | DawnBossSet | Medal | Shields
